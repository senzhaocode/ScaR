...
# The script was created in Nov. 11 2016, and the second latest modification in Nov 26 2017 (update annotation), and the latest modification in Dec 2nd, 2017 (resolve anchor problem)
###########################################################################################################################
use strict;
use warnings;
use Getopt::Std;
