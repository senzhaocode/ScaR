...
# Before you start it, make sure folder 'partner_gene_sim' is presence in the same path of script
# The script was created in Nov. 20 2017, and the latest modification in Feb. 28 2018 
###########################################################################################################################
use strict;
use warnings;
use Getopt::Std;
...
use Check;
	...
	push @usage, "	--scaffold	A list of fusion scaffold sequences in fasta format, e.g\n", 
		     ...
		     "			>scaffold2\n",
		     "			GCTCTATGAAATTGCA*AACAAAGAGAGGGTCA\n";
	push @usage, "	--anno		Set input annotation files for running script: e.g. /script_path/data/\n";
